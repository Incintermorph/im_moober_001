...
public class AuthenticInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		...
		//System.out.println("ADMIN" + authList.contains("ADMIN"));
		//System.out.println("ROLE_ADMIN "+ authList.contains("ROLE_ADMIN"));
		//관리자 권한 체크
		if(adminAuthUrlPatternMatcher && !authList.contains("ADMIN") && !authList.contains("ROLE_ADMIN")){
