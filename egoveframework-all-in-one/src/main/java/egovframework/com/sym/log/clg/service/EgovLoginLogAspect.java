...
public class EgovLoginLogAspect {
	...
	public void logLogin() throws Throwable {
    	...
    	if(isAuthenticated.booleanValue()) {
			...
			uniqId = (user == null || user.getUniqId() == null) ? "none" : user.getUniqId();
			ip = (user == null || user.getIp() == null) ? "none" : user.getIp();
			sesinId = (user == null || user.getSesinId() == null) ? "none" : user.getSesinId();
    	}
        ...
        IMLgnSttsVO lgnSttsVO = new IMLgnSttsVO();
        lgnSttsVO.setEsntlId(uniqId);
        lgnSttsVO.setMdfcnIp(ip);
        lgnSttsVO.setLastSesinId(sesinId);
        
        lgnSttsService.insertLgnStts(lgnSttsVO);
