...
public class BatchScheduler {
	...
	public void init() throws Exception {
		...
		if(egovBatchSchdulService==null) {
			System.out.println("egovBatchSchdulService is null");
		}else {
			System.out.println("egovBatchSchdulService is not  null");
		}
		try {
			targetList = egovBatchSchdulService.selectBatchSchdulList(searchVO);
		}catch (Exception e) {
			e.printStackTrace();
			System.out.println("egovBatchSchdulService selectBatchSchdulList error");
			List<BatchSchdul> list = new ArrayList<BatchSchdul>();
			targetList = list;
		}
