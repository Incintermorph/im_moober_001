...
public class EgovArticleController {
     ...
     * @throws Exception
     */
    @RequestMapping("/mng/cop/bbs/selectArticleList.do")
    public String selectArticleList(HttpServletRequest req, HttpServletResponse res,@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		if(master.getBbsTyCode().equals("BBST03")){
			return "forward:/mng/cop/bbs/selectGuestArticleList.do";
		}
		...
		//양성기관 담당자는 본인 기관에서 작성한 공지사항만 관리됨 
		if("BBSMSTR_000000000001".equals(master.getBbsId())){

			String loginAgncyId = IMStringUtil.getAttribute(req, IMGlobals.IM_LOGIN_USER_AGNCY_KEY);
			if (!"".equals(loginAgncyId)) {
				boardVO.setScAgncyId(loginAgncyId);
			}
...
//		return "egovframework/com/cop/bbs/EgovArticleList";
		return "layout/com/cop/bbs/EgovArticleList";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/mng/cop/bbs/selectArticleDetail.do")
    public String selectArticleDetail(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		if(!IMStringUtil.isEmpty(vo.getAtchFileId())) {
		...
		//비밀글은 작성자만 볼수 있음  
		if(!EgovStringUtil.isEmpty(vo.getSecretAt()) && vo.getSecretAt().equals("Y") && !masterVo.getAuthorCode().equals("ROLE_ADMIN") && !((user == null || user.getUniqId() == null) ? "" : user.getUniqId()).equals(vo.getFrstRegisterId()))
			return"forward:/mng/cop/bbs/selectArticleList.do";
...
//		return "egovframework/com/cop/bbs/EgovArticleDetail";
		return "layout/com/cop/bbs/EgovArticleDetail";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/mng/cop/bbs/insertArticleView.do")
...
//		return "egovframework/com/cop/bbs/EgovArticleRegist";
		return "layout/com/cop/bbs/EgovArticleRegist";
    }
...
//		    return "egovframework/com/cop/bbs/EgovArticleRegist";
     ...
     * @throws Exception
     */
    @RequestMapping("/mng/cop/bbs/replyArticleView.do")
...
//			return "egovframework/com/cop/bbs/EgovArticleReply";
			return "layout/com/cop/bbs/EgovArticleReply";
		}
    }
...
//		    return "egovframework/com/cop/bbs/EgovArticleReply";
     ...
     * @throws Exception
     */
    @RequestMapping("/mng/cop/bbs/updateArticleView.do")
...
//			return "egovframework/com/cop/bbs/EgovArticleUpdt";
			if(!IMStringUtil.isEmpty(bdvo.getAtchFileId())) {
				FileVO fileVO = new FileVO ();
				fileVO.setAtchFileId(bdvo.getAtchFileId());
				model.addAttribute("fileList", fileService.selectFileInfs(fileVO));
			}
			
			return "layout/com/cop/bbs/EgovArticleUpdt";
		}
    ...
    public String updateBoardArticle(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
		...
		System.out.println("board.getAtchFileId() 1 : " + vo.getAtchFileId());
		...
		if (isAuthenticated) {
			...
			System.out.println("board.getAtchFileId() : " + board.getAtchFileId());
...
//			return "egovframework/com/cop/bbs/EgovArticleDetail";
     ...
     * @throws Exception
     */
    @RequestMapping("/mng/cop/bbs/selectGuestArticleList.do")
...
//		return "egovframework/com/cop/bbs/EgovGuestArticleList";
		return "layout/com/cop/bbs/EgovGuestArticleList";
    }
...
//		    return "egovframework/com/cop/bbs/EgovGuestArticleList";
     ...
     * @throws Exception
     */
    @RequestMapping("/mng/cop/bbs/updateGuestArticleView.do")
