...
<%@ include file="incMmberCode.jspf" %>
			...
			<table class="tbl_data">
				...
				<thead>
					<tr>
						<th scope="col">과목명</th>
						<th scope="col">증빙 서류 (수료증)</th>
						<th scope="col">관리</th>
					</tr>
				</thead>
				<tbody>
					<c:forEach items="${selectExptSbjOnline}" var="row">
					<tr>
						<td>
						...
						<td>
							<div class="th">관리</div>
							<div class="td">
								<a href="javascript:;" onclick="REQ.modifyMmbrExptSbjOnline('${row.mmbrExptSbjId}')" class="c_btn sm b_green">수정</a>
							</div>
						</td>
					</tr>
					</c:forEach>
					<c:if test="${empty  selectExptSbjOnline}">
					<tr>
