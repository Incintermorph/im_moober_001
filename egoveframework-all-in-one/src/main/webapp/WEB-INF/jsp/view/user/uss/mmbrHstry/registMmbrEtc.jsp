...
var AJAX = {
	...
	initReq: function(){
		...
		this.req.save.cfg.url    =  "<c:url value="/user/mmbrEtc/insert.do"/>";
					...
					<table class="tbl_row al">
						...
						<tbody>
							<tr>
								...
								<td>
									<input type="text" name="etcItm" maxlength="20" class="wide" title="기타항목">
								</td>
							</tr>
							<tr>
								<th scope="row">기타증빙  *</th>
								<td>
									<input type="hidden" name="etcEvddocId" />
