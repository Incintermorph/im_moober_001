...
var REQ = {
	...
	init : function(){
		...
		this.req.save.cfg.url    =  "<c:url value="/mng/agncy/insert.do"/>";
	    ...
	    this.req.save.validator.set(function(){
	    	if(!COMMT.chkAttachFile('${SEAL_FILE_ID}')){
	    		...
	    		if(!COMMT.chkAttachFileSize(REQ.sealInfo)){
	    			return false;	
	    		}else{
	    			return true;
	    		}
...
<form:form commandName="iMAgncy" name="iMAgncy" id="iMAgncy" method="post" onsubmit="return false;" >
<table class="tbl_row">
	...
	<tbody>
			...
			<tr>
				...
				<td>
				<im:cd type="radio" codeId="IM0004" defaultSelectedCode="AGNCYDVSN_01" except="AGNCYDVSN_03"  name="agncyDvsnCdv"/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><im:cd type="checkbox" codeId="IM0001" name="crsGrdCdv"  /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<div id="img_view" style="width:auto;height:60px;margin-bottom:10px;margin-left:10px;"></div>
				</td>
			</tr>
			<tr>
				...
				<div id="seal_view" style="width:auto;height:60px;margin-bottom:10px;margin-left:10px;"></div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					...
					<textarea name="agncyintro" id="" cols="" rows="" style="height:100px;"></textarea>
				</td>
			</tr>
	</tbody>
</table>
