...
var REQ = {
	...
	init : function(){
		...
		this.req.save.cfg.url    =  "<c:url value="/mng/crsAplyTrnsf/insertExcel.do"/>";
...
<div class="b_box">
	<a href="<c:url value="/mng/crsAplyTrnsf/registExcel/sample.do"/>"  class="ad_btn green">샘플다운로드</a>
	<a href="#" onclick="REQ.save();return false;" class="ad_btn green">저장</a>
	
	<a href="<c:url value="/mng/crsAplyTrnsf/registExcelResult.do"/>" id="resultBtn" style="display: none;" class="ad_btn green">결과 다운로드</a>
