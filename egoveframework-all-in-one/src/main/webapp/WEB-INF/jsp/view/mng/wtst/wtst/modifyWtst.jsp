...
var REQ = {
	...
	init : function(){
		...
		this.req.save.cfg.url    =  "<c:url value="/mng/wtst/update.do"/>";
	    ...
	    this.req.del.cfg.formId = "iMWtst";
	    this.req.del.cfg.type   = "json";
	    this.req.del.cfg.url    = "<c:url value="/mng/wtst/delete.do"/>";
...
<table class="tbl_row">
	...
	<tbody>
			<tr>
				...
				<td><im:cd type="radio" codeId="IM0001" name="crsGrdCdv" selectedCode="${iMWtst.crsGrdCdv}" /></td>
			</tr>
			<tr>
				...
				<option value="${num}"
				<c:if test="${num eq  iMWtst.eduYear}">
					selected="selected"
				</c:if> 
			...
			<tr>
				...
				<option value="${num}"
				<c:if test="${num eq  iMWtst.eduRnd}">
					selected="selected"
				</c:if> 
				>${num}</option>
				</c:forEach>
			...
			<tr>
				...
				<td>
				<im:cd type="radio" codeId="${addtnYnArr}" name="addtnYn" selectedCode="${iMWtst.addtnYn}"/>
				</td>
			</tr>
			<tr>
				...
				<div class="ad_datepicker">
						<input type="text" name="pbancTerm_bgnDt" value="<im:dt yyyyMMddHHmmss="${cmmmDtMap['pbancTerm'].bgnDt}"/>"   placeholder="시작일" data-role="datepicker">
					</div>
					~
					<div class="ad_datepicker">
						<input type="text" name="pbancTerm_endDt" value="<im:dt yyyyMMddHHmmss="${cmmmDtMap['pbancTerm'].endDt}"/>"   placeholder="종료일" data-role="datepicker">
					</div>  
				</td>
			</tr>
			<tr>
				...
				<div class="ad_datepicker">
						<input type="text" name="rcptTerm_bgnDt" value="<im:dt yyyyMMddHHmmss="${cmmmDtMap['rcptTerm'].bgnDt}"/>"   placeholder="시작일" data-role="datepicker">
					</div>
					~
					<div class="ad_datepicker">
						<input type="text" name="rcptTerm_endDt" value="<im:dt yyyyMMddHHmmss="${cmmmDtMap['rcptTerm'].endDt}"/>"   placeholder="종료일" data-role="datepicker">
					</div>  
				</td>
			</tr>
			<tr>
				...
				<td>
				<div class="ad_datepicker">
				<input type="text" name="tstYmd" value="<im:dt yyyyMMddHHmmss="${iMWtst.tstYmd}"/>"  placeholder="<spring:message code="iMWtst.tstYmd"/>" data-role="datepicker">
				</div>
				</td>
			</tr>
			<tr>
				...
				<td>
						<input type="text" name="tstBgngHrs" value="${iMWtst.tstBgngHrs}" maxlength="5" class="timeCHEK" style="width: 60px;">
						~
						<input type="text" name="tstEndHrs" value="${iMWtst.tstEndHrs}" maxlength="5" class="timeCHEK" style="width: 60px;">
				</td>
			</tr>
			<tr>
				...
				<div class="ad_datepicker">
						<input type="text" name="passTerm_bgnDt"  value="<im:dt yyyyMMddHHmmss="${cmmmDtMap['passTerm'].bgnDt}"/>"  placeholder="시작일" data-role="datepicker">
					</div>  
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<textarea name="ntce" id="" cols="" rows="" style="height:100px;">${cmmmDescMap['ntce']}</textarea>
				</td>
			</tr>
			<tr>
				...
				<textarea name="brng" id="" cols="" rows="" style="height:100px;">${cmmmDescMap['brng']}</textarea>
				</td>
			</tr>
			
			<tr>
				<th scope="row"><spring:message code="iMWtst.stts"/><span class="c_red">*</span></th>
				<td><im:cd type="radio" codeId="IM0003" selectedCode="${iMWtst.sttsCdv}" name="sttsCdv"/></td>
			</tr>
