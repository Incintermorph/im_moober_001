...
var REQ = {
	...
	init : function(){
		...
		this.req.search.cfg.url    = "<c:url value="/mng/agncy/place/selectList.do"/>";
		

		this.req.regist = imRequest();
		this.req.regist.cfg.formId = "FormPageDetail";
		this.req.regist.cfg.url    = "<c:url value="/mng/agncy/place/regist.do"/>";
		
		this.req.modify = imRequest();
		this.req.modify.cfg.formId = "FormPageDetail";
		this.req.modify.cfg.url    = "<c:url value="/mng/agncy/place/modify.do"/>";
...
<c:set var="scKey">agncyNm=<spring:message code="iMAgncy.placeNm" /></c:set>
	<div class="sch_box">	
		<div class="group">
...
<table class="tbl_col">
	...
	<thead>
		<tr>
			...
			<th scope="col"><spring:message code="iMAgncy.useYn"/></th>
