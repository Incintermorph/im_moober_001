	...
	updateCrsAply : function(){
		<c:if test="${detail.wtstPlace.prgrsSttsCdv eq '01'}">
		 var req = imRequest("ajax",{formId: "FormPageDetail"});
			req.cfg.type   = "json";			
			req.cfg.url    =  "<c:url value="/mng/wtstPlace/02/updatePrgrsSttsCdv.do"/>";
			req.cfg.message.confirm="모든 대상자에 대한 자격심사가 완료되었는지 다시 한번 확인해 주세요<br>선정확정을 하시겠습니까?";
	...
	<div class="sch_box">
		<div class="group">
			...
			<select name="aplcnt.scFnshYn" onchange="REQ.search()" >
				...
				<im:cd type="option" codeId="IMYENO"  selectedCode="${condition.aplcnt.scFnshYn}"/>
			</select>	
		</div>
		<div class="group">
...
<div class="cb_bar">
	...
	<div>
	 ...
	 <im:cd type="option" codeId="IM0017" except="04"/>
	 </select>
...
<table class="tbl_col">
	...
	<tbody>
		...
		<tr>
			...
			<td>
			<im:cd type="print" codeId="IMYENO" selectedCode="${row.fnshYn}"/>
			</td>
			<td>
