...
<!-- 콘텐츠 -->
<form:form commandName="articleVO" action="${pageContext.request.contextPath}/cop/bbs/replyArticle.do" method="post" onSubmit="fn_egov_reply_article(document.forms[1]); return false;" enctype="multipart/form-data"> 
<!-- 상단타이틀 -->
...
<table class="tbl_row" summary="<spring:message code="common.summary.list" arguments="${pageTitle}" />">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<form:input path="ntceBgnde" title="${title} ${inputTxt}" size="70" maxlength="70"  style="width:100px;"/>
				&nbsp;~&nbsp;<form:input path="ntceEndde" title="${title} ${inputTxt}" size="70" maxlength="70"  style="width:100px;"/>
