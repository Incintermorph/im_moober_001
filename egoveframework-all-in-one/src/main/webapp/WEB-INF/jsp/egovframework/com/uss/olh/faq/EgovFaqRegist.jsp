...
<!-- 콘텐츠 -->
<form:form commandName="faqVO" action="${pageContext.request.contextPath}/uss/olh/faq/insertFaq.do" method="post" onSubmit="fn_egov_regist_faq(document.forms[1]); return false;" enctype="multipart/form-data">
...
<div class="b_box right">
	<input type="submit" class="ad_btn green mid" value="<spring:message code="button.create" />" title="<spring:message code="button.create" /> <spring:message code="input.button" />" />
