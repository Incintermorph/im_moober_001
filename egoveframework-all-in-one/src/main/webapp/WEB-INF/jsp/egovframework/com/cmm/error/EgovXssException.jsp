...
<body>
<c:set var="pageTitle"><spring:message code="comCmmErr.sessionException.code"/></c:set><!-- 비즈니스로직처리 에러 -->
	<div class="p_error">
		<div class="inner">
			<div class="img">
			...
			<h1>
				${exception.message} :: <spring:message code="${exception.messageKey}"/>
				<span>User authorization Error</span>
			</h1>
			<div class="help">
