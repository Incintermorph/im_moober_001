...
<script type="text/javascript">
    var DEFAULT_URL = '<c:out value="${param['path']}"/>';
    </script>
      ...
      <div id="mainContainer">
        ...
        <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
          <div id="secondaryToolbarButtonContainer">
            ...
            <button id="documentProperties" class="secondaryToolbarButton documentProperties" title="Document Propertiesâ¦" tabindex="69" data-l10n-id="document_properties">
